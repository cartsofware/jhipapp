package eu.cartsc.jhipapp.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipapp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipapp API";

        private String description = "jhipapp API documentation";
